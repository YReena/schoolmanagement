...
const Secondsem = () => {
    ...
    const submitMarks = async (e) => {
        e.preventDefault();
        const { admissionno, secsem } = marks;
        const marksAdd = await fetch('/secondsem', {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
        ...
        <div className='form'>
            <div className='container'>
                ...
                <form method='POST' >
                    ...
                    <div>
                        <h3 className='sem-name'>Second Semester</h3>
                        <Grid container>
                            <Grid item xs={4}>
                                <MDBTable>
                                    <MDBTableHead dark>
                                        ...
                                        {Subject.map((ele, id) => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" className="form-control" placeholder="0" style={{ "margin-bottom": "0px" }} onChange={handlemarks} value={marks.secsem[ele.subject]} name={ele.subject} />
                                                    </td>
                                                </tr>
